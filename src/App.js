...
function App() {
  ...
  const switchmode = () => {
    if (mode === 'light') {
      setMode("dark");
      document.body.style.backgroundColor = '#6F8FAF'
  ...
  return (<>
    ...
    <Navbar title="WoodKeeep" subTitle="contact us " mode={mode} sub='here we go!' switchmode={switchmode} switchmode2={switchmode2} />
